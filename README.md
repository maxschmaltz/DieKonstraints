...
* We used two original datasets for our corpus study: CELEX2 (`baayen_etal_1995`) found in [resources/Celex/](resources/Celex/) and DeCOW16AX-comps (`schaefer_pankratz_2018`) in [resources/DeCOW16AX-comps/](resources/DeCOW16AX-comps/). Both sources are unavailable in the public version due to the copyright restrictions. DeCOW16AX-comps can, however, be accessed under https://doi.org/10.5281/zenodo.1323211 (file 'linkingelements/Data/Database/compounds/decow16ax_comps_counts.txt'). _Please note that in the present study, we used a derivative of DeCOW16AX-comps we had previously preprocessed in a different research (see [maxschmaltz/DEKOR](https://github.com/maxschmaltz/DEKOR)). In order to not repeat the preprocessing steps from [maxschmaltz/DEKOR](https://github.com/maxschmaltz/DEKOR), we took it from there and applied further preprocessing. Thus, the original 22M+ compounds can be found under https://doi.org/10.5281/zenodo.1323211, [resources/DeCOW16AX-comps/](resources/DeCOW16AX-comps/) is an intermediately preprocessed version from [maxschmaltz/DEKOR](https://github.com/maxschmaltz/DEKOR), and [resources/developed/gecodb_v06.tsv](resources/developed/gecodb_v06.tsv) is the third-generation derivative originating from the present study (see below)._
...
* [lrec26/](lrec26/) contains [the certificate of attendance](lrec26/cert_of_attendance.pdf) of the conference, the [slides for the oral presentation](lrec26/slides/LREC%20Talk%20Slides.key) at the SLiDE workshop at LREC26 as well as supplementary materials (only in the private version).
